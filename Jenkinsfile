pipeline 
{
    ...
    //nexus  
       ...
       stage('Publish to nexus') {
        steps {
                echo 'Nexus ...'
                sh 'mvn deploy:deploy-file -DgroupId=tn.esprit.rh -DartifactId=achat -Dversion=1.0 -DgenerationPom=true -Dpackaging=jar -DrepositoryId=deploymentRepo -Durl=http://192.168.1.24:8081/repository/maven-releases -Dfile=target/SpringProject-1.0.jar'
            }
    }
